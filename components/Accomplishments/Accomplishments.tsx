...
export default function Accomplishments() {
  ...
  const experience = [
    ...
    {img: './images/redlight.png', imgClass: 'logo', imgAlt: 'Logo of the RedLight Software company', title: t('redlight.title'), description: t.rich('redlight.info', {link: (chunks) => <a target='_blank' href='https://redlight.dev/project/vive-na-boa/'>{chunks}</a>})},
  ];
